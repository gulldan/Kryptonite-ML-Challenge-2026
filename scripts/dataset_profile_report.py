"""Generate a reproducible dataset profile report from the current manifests."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("artifacts/eda/dataset-profile"),
...
def main() -> None:
    ...
    written = write_dataset_profile_report(report=report, output_root=args.output_dir)
    print(
        json.dumps(
            {
                **written.to_dict(),
