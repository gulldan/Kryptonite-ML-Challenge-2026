...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--stage-a-config",
        default="configs/training/campp-ms37-cnceleb-mixed-subcenter-lowlr.toml",
    )
    parser.add_argument(
        "--stage-b-config",
        default="configs/training/campp-ms37-cnceleb-mixed-subcenter-lmft.toml",
    )
    parser.add_argument(
        "--stage-a-output-root",
...
def _build_cnceleb_manifest(args: argparse.Namespace) -> dict[str, Any]:
    command = [
        sys.executable,
        "scripts/build_cnceleb_manifests.py",
        "--root",
        args.cnceleb_root,
        "--output-dir",
