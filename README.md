...
See [docs/triton-deployment.md](./docs/triton-deployment.md) for the Triton model-repository packaging path that serves the encoder-only export boundary through KServe `/v2/models/.../infer`.
