...
> Архивный organizer baseline. Эта директория сохранена как историческая справка и
> воспроизводимая ссылка на исходное baseline-решение, но не является основным
> источником истины для текущего репозитория. Канонический toolchain и рабочие точки входа живут
> в корне репозитория, `src/kryptonite/`, `configs/` и `scripts/`.
