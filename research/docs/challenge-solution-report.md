...
Архивный research-документ. Он сохраняет исторический narrative вокруг `MS41`, но не
определяет текущий финальный submit path репозитория. Актуальное состояние и будущий
layout описаны в [../../TODO.md](../../TODO.md) и [../../README.md](../../README.md).

Этот документ сделан как самодостаточная версия для жюри: по нему можно понять,
почему на момент его написания сильным кандидатом считался `MS41`, не читая весь
`trails/`. Файл [challenge-experiment-history.md](./challenge-experiment-history.md)
остаётся полным лабораторным журналом, а [trails/](./trails/) содержат команды, логи
и расширенные записи.

Update 2026-04-16:

- После подготовки этого отчёта более новая ветка
  `W2V1j_teacher_peft_public_c4_20260416T131620Z_fast_bs1024_w4p1`
  получила `0.8344` на public leaderboard и стала текущим лучшим зафиксированным
  кандидатом в репозитории.
- Этот документ сохраняется как историческое объяснение, почему на момент его написания
  был выбран `MS41`; за текущим лидером нужно смотреть в
  [trails/current-public-submission-artifact.md](./trails/current-public-submission-artifact.md)
  и [challenge-experiment-history.md](./challenge-experiment-history.md).
