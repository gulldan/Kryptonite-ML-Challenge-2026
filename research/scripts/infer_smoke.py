...
from kryptonite.runtime.deployment import build_infer_artifact_report
from kryptonite.runtime.inferencer import Inferencer
from kryptonite.runtime.runtime import (
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--config",
        type=Path,
        default=Path("research/configs/deployment/infer.toml"),
