"""Train the ERes2NetV2 baseline, export dev embeddings, and write cosine scores."""
...
CONFIG_OPTION = typer.Option(
    Path("research/configs/training/eres2netv2-baseline.toml"),
    "--config",
    help="Path to the ERes2NetV2 baseline TOML config.",
)
...
def main(
    ...
    artifacts = run_eres2netv2_baseline(
        baseline,
        config_path=config,
    ...
    typer.echo(
        "\n".join(
            [
                "ERes2NetV2 baseline run complete",
