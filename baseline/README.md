...
> воспроизводимый reference к исходному baseline-решению, но не является source of
> truth для текущего репозитория. Канонический toolchain и рабочие entrypoints живут
