...
from kryptonite.runtime.inference_package import load_inference_package_from_model_metadata
    ...
    *,
    ...
    profiles = tuple(
        TensorRTFP16Profile(
            ...
            min_shape=(profile.min_batch_size, profile.min_frame_count, mel_bins),
            opt_shape=(profile.opt_batch_size, profile.opt_frame_count, mel_bins),
            max_shape=(profile.max_batch_size, profile.max_frame_count, mel_bins),
        )
    ...
    engine_bytes = _build_serialized_tensorrt_engine(
        ...
        builder_optimization_level=config.build.builder_optimization_level,
    )
