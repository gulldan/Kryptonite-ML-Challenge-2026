...
def run_dense_gallery_package(
    *,
    ...
    _write_bucket_breakdown(query_eval_all, output_dir / "dense_gallery_bucket_breakdown.csv")
...
def _write_bucket_breakdown(query_eval: pl.DataFrame, path: Path) -> None:
    file_stats = pl.read_parquet("artifacts/eda/eda_review_package/05_local_file_stats.parquet")
